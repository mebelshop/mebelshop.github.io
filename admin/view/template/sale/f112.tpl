      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="<?php echo $F112;?>">Бланк Ф.112</a></li>
            <li><a href="<?php echo $F116;?>">Бланк Ф.116</a></li>
            <li><a href="<?php echo $F107;?>">Бланк Ф.107</a></li>
          </ul>
...
<!-- Begin page content -->
<div class="container">
 <div class="page-header"><h1>Печать бланка наложенного платежа Ф.112 / заказ #<?php echo $order_id;?></h1></div>
 <div id="info"></div>

<div class="col-md-6">
<form role="form" id="blank">
  <div class="form-group">
    <label for="FIO">ФИО отправителя перевода</label>
...
<input type="hidden" name="blank_type" value="F112">
<input type="hidden" name="cod" value="1">
<input type="hidden" name="comment1" value="Оплата заказа #<?php echo $order_id;?>">
<input type="hidden" name="order_id" value="<?php echo $order_id;?>">

<input type="hidden" name="inn" value="<?php echo $this->config->get('digipost_inn');?>">
<input type="hidden" name="correspondent_account" value="<?php echo $this->config->get('digipost_correspondent_account');?>">
<input type="hidden" name="current_account" value="<?php echo $this->config->get('digipost_current_account');?>">
<input type="hidden" name="bank_name" value="<?php echo $this->config->get('digipost_bank_name');?>">
<input type="hidden" name="bik" value="<?php echo $this->config->get('digipost_bik');?>">
...
<div class="well" style="max-width: 400px; margin: 0px auto 10px;"><a href="#" data-loading-text="Создаем бланк..." data-complete-text="Скачать бланк!" id="print-blank-btn" class="btn btn-primary btn-lg btn-block">Создать бланк Ф.112</a></div>
...
$.ajax({
	type: "POST",
	data: { order_id: "<?php echo $order_id;?>", "blank_type": "F112"},
