      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="<?php echo $F116;?>">Бланк Ф.116</a></li>
...
<!-- Begin page content -->
<div class="container">
 <div class="page-header"><h1>Печать сопроводительного бланка Ф.116 / заказ #<?php echo $order_id;?></h1></div>
 <div id="info"></div>
...
<input type="hidden" name="blank_type" value="F116">
...
<div class="well" style="max-width: 400px; margin: 0px auto 10px;"><a href="#" data-loading-text="Создаем бланк..." data-complete-text="Скачать бланк!" id="print-blank-btn" class="btn btn-primary btn-lg btn-block">Создать бланк Ф.116</a></div>
...
$.ajax({
	type: "POST",
	data: { order_id: "<?php echo $order_id;?>", "blank_type": "F116"},
