      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"> <a href="<?php echo $F7;?>">Бланк Ф.7 <span id="badge" class="badge"></span></a> </li>
...
<!-- Begin page content -->
<div class="container">
 <div class="page-header"><h1>Печать адресного ярлыка Ф.7 / заказ #<?php echo $order_id;?></h1></div>
 <div id="info"></div>
...
<form role="form" id="blank">
  ...
  <div class="form-group">
  	<label for="blank_type_id">Тип посылки</label>
  	<div class="radio"><label><input type="radio" name="blank_type_id" value="1" checked>Отправление первого класса</label></div>
  	<div class="radio"><label><input type="radio" name="blank_type_id" value="2">Посылка</label></div>
  	<div class="radio"><label><input type="radio" name="blank_type_id" value="3">Бандероль</label></div>
  </div>
...
<div class="well" style="max-width: 400px; margin: 0px auto 10px;"><a href="#" data-loading-text="Создаем бланк..." data-complete-text="Скачать бланк!" id="print-blank-btn" class="btn btn-primary btn-lg btn-block">Создать бланк Ф.7</a></div>
...
$.ajax({
	type: "POST",
	data: { order_id: "<?php echo $order_id;?>", "blank_type": "F7"},
